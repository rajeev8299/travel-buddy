// Sunrise over the Varanasi ghats, drawn rather than photographed — shown
// whenever a hero/page-banner photo fails to load. Shared by hero.js and
// page-header.js.
const GHATS_PANORAMA_SVG = `<svg viewBox="0 0 1200 440" preserveAspectRatio="xMidYMid slice" role="img" aria-label="Sunrise over the ghats of Varanasi, with temple spires and boats on the Ganga">
  <defs>
    <linearGradient id="bt-sky" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#EF8F1F" />
      <stop offset="52%" stop-color="#F9BE71" />
      <stop offset="100%" stop-color="#FFE6BE" />
    </linearGradient>
    <linearGradient id="bt-river" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#C9762A" />
      <stop offset="100%" stop-color="#7E4211" />
    </linearGradient>
    <radialGradient id="bt-glow">
      <stop offset="0%" stop-color="#FFF6E0" stop-opacity="0.95" />
  ...
  <g stroke="#7E4211" stroke-width="2.5" fill="none" stroke-linecap="round" opacity=".55">
